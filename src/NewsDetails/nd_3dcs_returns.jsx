...
export function ND_3DCS_RETURNS() {
  // Assuming you want to display the first item; modify index as needed
  const item = data[2]; 
    ...
    <>
      <div className="container">
        <div className="font-sans text-3xl text-start leading-tight py-8 font-semibold">
          3DCS Returns To Startup Roots With MIP Partnership
        </div>
        <p className="font-sans text-lg font-semibold leading-tight text-start">
          3D CityScapes got its start with McMaster Innovation Factory's help.
        </p>
